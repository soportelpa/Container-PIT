...
function mini_requirement(){
	...
	* Mac OS X 10.15.x 
	* Docker CE or EE 20.10.x
	* OpenLDAP 1.5.0 container from:
	 	https://hub.docker.com/r/osixia/openldap/
	* DB2 Container v11.5.6.0 from:
		https://hub.docker.com/r/ibmcom/db2
	* IBM FileNet Content Platform Engine 5.5.7 and
	  IBM Content Navigator 3.0.10 containers from:
